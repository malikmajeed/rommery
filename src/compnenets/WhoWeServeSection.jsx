        ...
        <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
          ...
          >
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
              <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                <p className="mt-2 text-xl font-medium tracking-tight text-gray-950 max-lg:text-center">Boutique Hotels</p>
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">Deliver seamless, contactless stays while maintaining a personalized guest experience. Ideal for properties focused on service quality and operational efficiency.</p>
              </div>
          ...
          >
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                <p className="mt-2 text-xl font-medium tracking-tight text-gray-950 max-lg:text-center">Vacation Rentals</p>
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">Automate guest access completely with 24/7 self-service check-ins. Manage multiple units from one dashboard with instant digital key generation.</p>
              </div>
          ...
          >
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                <p className="mt-2 text-xl font-medium tracking-tight text-gray-950 max-lg:text-center">Serviced Apartments</p>
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">Perfect for short and long stays. Enable digital check-in, mobile key access, and automated guest management for a seamless resident experience.</p>
              </div>
              <div className="px-5 pt-10">
          ...
          >
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
              <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                <p className="mt-2 text-xl font-medium tracking-tight text-gray-950 max-lg:text-center">Hotel Chains & Resorts</p>
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">Enterprise-grade hospitality automation that scales across all your properties. Centralized management, consistent guest experience, and powerful operational analytics.</p>
              </div>
